...
const DashboardPage = () => {
  ...
  const handleStopRecording = async () => {
    ...
    try {
      ...
      if (blob) {
        ...
        // In a real app, you would send this blob to your transcription service
        // For now, we'll simulate a transcription after a delay
        setTimeout(() => {
          setTranscriptionText('This is a simulated transcription of your audio recording. In a production environment, this would be the actual transcription of your speech.');
  ...
  const SettingsModal = () => {
    const { logout } = useAuth(); // Add this line to access logout function from useAuth
                  ...
                  {currentSubscription?.active ? (
                    <div className="bg-gray-50 rounded-xl p-8 flex flex-col items-center justify-center">
                      ...
                      <div className="flex items-center justify-center space-x-6 mb-6">
                        ...
                        {audioBlob && (
                          <button 
                            className="w-16 h-16 rounded-full bg-blue-100 text-primary-600 flex items-center justify-center hover:bg-blue-200 transition-colors"
                            onClick={() => {
                        ...
                        {!isRecording ? (
                          <button 
                            className="w-24 h-24 rounded-full flex items-center justify-center shadow-lg bg-primary-500 text-white hover:bg-primary-600 transition-colors"
                          ...
                          <button 
                            className="w-24 h-24 rounded-full flex items-center justify-center shadow-lg bg-red-500 text-white hover:bg-red-600 transition-colors"
                      ...
                      <p className="text-center text-gray-400 text-sm mt-4">
                        ...
                        {isRecording ? 'Recording in progress...' : 'Click the microphone to start recording (2 hour limit)'}
                      </p>
